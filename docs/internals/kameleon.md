...
This kind of diagnostic — wrap every Embind import, decode the C string args from the heap, watch what's read — is reusable for any other Snap WASM. The same approach should crack [Fidelius](/internals/why-it-works) once we figure out how its sibling files are decrypted.
