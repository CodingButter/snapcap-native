...
Defined in: [api/stories.ts:38](https://github.com/CodingButter/snapcap-native/blob/main/src/api/stories.ts#L38)
...
Defined in: [api/stories.ts:80](https://github.com/CodingButter/snapcap-native/blob/main/src/api/stories.ts#L80)
